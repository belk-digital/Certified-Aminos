  ...
  theme: {
    extend: {
      colors: {
        background: '#0a1323',
        primary: {
          DEFAULT: '#dcf53b', // Certified Aminos accent green
          dark: '#a8cd24',
        },
        'card-bg': 'rgba(255, 255, 255, 0.05)',
        navy: {
          DEFAULT: '#0a1323', // page/section background navy
          deep: '#011638', // deeper navy used by nav/footer chrome
        },
        // Backgrounds
        cream: {
          DEFAULT: '#FAF7F2',
      ...
      fontFamily: {
        ...
        display: ['Vipnagorgialla', 'sans-serif'],
      ...
      boxShadow: {
        ...
        focus: '0 0 0 3px rgba(220, 245, 59, 0.4)',
      },
      maxWidth: {
        content: '720px',
        prose: '960px',
