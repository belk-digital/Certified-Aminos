      ...
      <div className="w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 rc-cards-grid mt-4">
          {products.map((product) => (
            <div key={product.id} className="rc-card h-full">
              <div className="flex flex-col group cursor-pointer h-full bg-[#f0f4fa] rounded-xl md:rounded-2xl border border-[#1e3a8a]/10 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative">
