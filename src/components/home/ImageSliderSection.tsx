...
const slides = [
  { id: 1, src: '/brand-images/vial_on_sand_minimal.jpg', alt: 'Certified Aminos Slide 1' },
  { id: 2, src: '/brand-images/hero_vials_lab.jpg', alt: 'Certified Aminos Slide 2' },
  { id: 3, src: '/brand-images/vial_on_sand_minimal.jpg', alt: 'Certified Aminos Slide 3' },
]
