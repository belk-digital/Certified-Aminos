...
export function ResearchGradePeptides() {
  return (
    <section className="w-full bg-white flex flex-col pt-16 md:pt-24 pb-0">
      <div className="w-full max-w-[1400px] mx-auto px-8 relative z-20">
        <div className="flex flex-col items-center text-center max-w-6xl mx-auto">
          ...
          <h2 className="font-syncopate text-navy-deep text-3xl sm:text-4xl md:text-[3.5rem] lg:text-[4.5rem] font-medium leading-[1.1] tracking-wide mb-6 uppercase break-words">
            The Lab Difference
          </h2>
          <p className="text-gray-500 font-inter text-[9px] md:text-[11px] tracking-[0.2em] uppercase font-semibold leading-relaxed max-w-2xl">
            Every batch undergoes rigorous third-party testing. Access our Certificates of
            Analysis (COA) to verify the purity and quality of our compounds.
          </p>
          <Link
            href="/certificates"
            className="mt-8 flex items-center justify-center gap-3 px-8 py-3.5 bg-[#1f2533] text-white text-[11px] font-semibold tracking-[0.2em] uppercase rounded-sm hover:bg-[#354363] transition-colors"
          >
            <span>View COA</span>
            <svg
              width="14"
