...
export const Products: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      defaultValue: 'none',
      admin: {
        description: 'Optional badge shown on the product card (homepage, shop, related products).',
        position: 'sidebar',
      },
    },
    {
      ...
      label: 'Dose Sizes',
      admin: {
        description: 'Dose-size pills shown on the product card (e.g. 5MG, 10MG). Purely display — does not affect variants/pricing.',
        position: 'sidebar',
      },
      fields: [
