              ...
              <div className="space-y-20">
                ...
                <section id="section5" className="scroll-mt-32">
                  ...
                  <p className="text-[15px] leading-relaxed mt-4">
                    ...
                    {t('section5EmailLabel')} <a href="mailto:support@certified-aminos.com" className="hover:text-[#1e5661] transition-colors break-all">support@certified-aminos.com</a>
                  </p>
                </section>
