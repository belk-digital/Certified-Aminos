            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
              <FadeUp delay={0.2}>
                <div className="relative w-full aspect-[4/3] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl group">
                  <Image src="/brand-images/vial_on_sand_minimal.jpg" alt="Peptide Vials" fill className="object-cover group-hover:scale-105 transition-transform duration-1000 ease-out" />
